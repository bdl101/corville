...
- **Entity Statblock improvements** - show attack bonus next to attach name (i.e. "Rustswords (+5)")
- **Entity Statblock improvements** - if link exists between entity attack note and entity feature, denote with an asterisk . if different attacks link to different features, denote using stacking asterisks (\* for first link, \*\* for second etc.)
